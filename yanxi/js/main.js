(function () {
  var VideoItem = {
    id: ['#media', '#loading-info-number', '#loading', '#mask', '#play-container', '#media-container','#play','#mask-black'],
